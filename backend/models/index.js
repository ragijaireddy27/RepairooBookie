...
// MongoDB URI (replace with your MongoDB Atlas URI or local database URI)
const mongoURI = 'mongodb://localhost:27017/repairooBookie'; // Local MongoDB URI
// or use MongoDB Atlas URI: 'mongodb+srv://<username>:<password>@cluster0.mongodb.net/repairooBookie'
...
// Define the Worker model schema
